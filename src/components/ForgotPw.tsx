...
import { Button, Form, Input, Card, notification, Layout } from "antd";
  ...
  const onFinish = async (values: string) => {
    try {
      ...
      const response = await fetch(
        "https://api-training.hrm.div4.pgtest.co/api/v1/forgot-password",
        {
          method: "POST",
            ...
            >
              ...
              <Form.Item>
                <Button
                  ...
                  htmlType="submit"
                >
                  {loading ? <Spin indicator={antIcon} /> : "Confirm & Send OTP"}
                </Button>
              </Form.Item>
